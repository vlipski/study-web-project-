...
public class ButtonMinusTemperature extends Button {
    private Integer value;

    public ButtonMinusTemperature(Composite parent, int style, Button displayTemperature) {
        super(parent, style);
        this.setText("-");
        ...
        this.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                if (getOnOff()) {
                    value = Integer.valueOf(displayTemperature.getText());
                    if (value > 15) {
                        value--;
